// launchActions.js
import { setLaunches, setFilteredLaunches, setStartDate, setEndDate, setLaunchType, setIsModalOpen, setSelectedLaunch } from '@/redux/reducers/launchReducer';
...
export const fetchLaunches = (launchType) => async (dispatch) => {
  try {
    ...
    if (launchType === 'upcoming') {
      apiUrl = 'https://api.spacexdata.com/v4/launches/upcoming';
